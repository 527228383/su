...
<title></title>
	...
	<body >
		...
		<div class="breadcrumb"> 首页 <span class="c-gray en">&gt;</span> 客户理赔管理 <span class="c-gray en">&gt;</span> <span id="cdType">待处理</span> </div>
		<div class="Hui-article">
			<div class="cl pd-20">
			<div id="searchDiv" style="border: 1px soild red">
				<form action="act/getNoDealWithClaimDetails" method="get" id="page">
				...
				<table class="table table-border table-bordered table-hover table-bg">
					<thead>
						...
						<tr class="text-c">
							<th style="text-align: center" width="40">保单号</th>
							<th style="text-align: center" width="60">保险名称</th>
							<th style="text-align: center" width="40">被保人</th>
							<th style="text-align: center" width="130">被保人身份证</th>
							<th style="text-align: center" width="90">联系电话</th>
							<th style="text-align: center" width="70">保单截止日期</th>
							<th style="text-align: center" width="60">保险费</th>
							<th style="text-align: center" width="40">经办人</th>
					...
					<c:forEach items="${list}" var="p">
						<tr  class="tr2" onmouseover="this.style.backgroundColor='#ffff66';" onmouseout="this.style.backgroundColor='#d4e3e5';">
								<td style="text-align: center"><font size="2.5">${p.pol_id }</font></td>
								<td style="text-align: center"><font size="2.5">${p.pro_name }</font></td>
								<td style="text-align: center"><font size="2.5">${p.assurerDto.ass_name }</font></td>
								<td style="text-align: center"><font size="2.5">${p.assurerDto.ass_id_card }</font></td>
								<td style="text-align: center"><font size="2.5">${p.assurerDto.ass_tel }</font></td>
								<td style="text-align: center"><font size="2.5"><fmt:formatDate value="${p.expirationDate }" pattern="yyyy-MM-dd" /></font></td>
								<td style="text-align: center"><font size="2.5">${p.b_coverage }</font></td>
								<td style="text-align: center"><a href="/mannager/listSalesDel?emp_id=${p.sales_id }"><font size="2.5px">${p.sales_name }</font></a></td>
